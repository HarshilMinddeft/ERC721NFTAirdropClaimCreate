...
const UserAirdropdata = () => {
  ...
  // const formateIDS = (tokenids) => {
  //   if (!tokenids) return "InvalidData";
  // };
    ...
    if (excelFile) {
      ...
      try {
        ...
        try {
          ...
          console.log("BeforeContract=>", claimAmounts);
          const transaction =
